...
<div class="my_meta_control">
	<div id="sliderProperties">
		...
		<p>
			<label for="<?php $metabox->the_name(); ?>">Título: </label>
		...
		<p><label >URL da Imagem: </label><?php echo $wpalchemy_media_access -> getField(array('name' => $metabox -> get_the_name(), 'value' => $metabox -> get_the_value(), 'style' => "width: 100%; min-width: 400px;")); ?>
		<?php echo $wpalchemy_media_access -> getButton(); ?></p>

		<?php $metabox -> the_group_close(); ?>
		<?php endwhile; ?>
		<p style="padding:8px; border-top: 1px solid #DFDFDF;"><a href="#" class="docopy-docs button">Add Imagem </a><a href="#" class="dodelete-docs button"> Apagar Tudo</a></p>
	</div>
</div>
<div class="clear"></div>